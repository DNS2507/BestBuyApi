...
//31. Get all the descriptions of all the products
    ...
    public void Getallthedescriptionsofalltheproducts(){
        ...
        System.out.println("List of description : "+ description);
    }
//32. Get id of all the all categories of all the products
    @Test
    public void Getidofalltheallcategoriesofalltheproducts(){
        List<String>allcategories=response.extract().path("data.categories.id");
        System.out.println("List of allcategories : "+ allcategories);
    }
